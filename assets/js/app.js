...
document.oninput = function () {
  var input = document.querySelector('.phone-mask');
  input.value = input.value.replace(/[^\+\d]/g, '');
};

var anchors = document.querySelectorAll('a.js-ancor');
var mobileAnchors = document.querySelectorAll('a.js-mobile-ancor');
var menuMobile = document.querySelector('.hollidays__menu-mobile');
var toggler = document.querySelector('.hollidays__toggler');
...
var ancorHandler = function ancorHandler(collections) {
...
$(document).on('scroll', function () {
  ...
  sections.forEach(function (el, i) {
    if (el.offsetTop - (parseInt($(el).css('paddingTop')) + 40) <= window.scrollY) {
      ...
      mobileAnchors.forEach(function (el) {
        if (el.classList.contains('active')) {
          el.classList.remove('active');
        }
...
!function webpackUniversalModuleDefinition(root, factory) {
  if ("object" == ( false ? 0 : _typeof2(exports)) && "object" == ( false ? 0 : _typeof2(module))) module.exports = factory(__webpack_require__(311));else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(311)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
		__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
		(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
  ...
  return modules = [function (module) {
  ...
  }, function (module, exports, __nested_webpack_require_1551__) {
    "use strict";
    ...
    var $ = __nested_webpack_require_1551__(2),
        window = __nested_webpack_require_1551__(4),
        document = window.document,
        generateMaskSet = __nested_webpack_require_1551__(5).generateMaskSet,
        analyseMask = __nested_webpack_require_1551__(5).analyseMask,
        maskScope = __nested_webpack_require_1551__(9);
    ...
    function resolveAlias(aliasStr, options, opts) {
      ...
      if (aliasDefinition) return aliasDefinition.alias && resolveAlias(aliasDefinition.alias, void 0, opts), $.extend(!0, opts, aliasDefinition), $.extend(!0, opts, options), 1;
    ...
    var jquery = __nested_webpack_require_12152__(3);

    if (void 0 === jquery) throw "jQuery not loaded!";
    module.exports = jquery;
  }, function (module, exports) {
    module.exports = __WEBPACK_EXTERNAL_MODULE__3__;
  }, function (module, exports, __nested_webpack_require_12439__) {
    "use strict";
    ...
    }.call(exports, __nested_webpack_require_12439__, exports, module), void 0 === __WEBPACK_AMD_DEFINE_RESULT__ || (module.exports = __WEBPACK_AMD_DEFINE_RESULT__);
  }, function (module, exports, __nested_webpack_require_13234__) {
    "use strict";

    var $ = __nested_webpack_require_13234__(2);
  ...
  }, function (module, exports, __nested_webpack_require_27974__) {
    "use strict";

    __nested_webpack_require_27974__(8), __nested_webpack_require_27974__(11), __nested_webpack_require_27974__(12), __nested_webpack_require_27974__(13), module.exports = __nested_webpack_require_27974__(1);
  }, function (module, exports, __nested_webpack_require_28192__) {
    "use strict";

    var Inputmask = __nested_webpack_require_28192__(1);
  ...
  }, function (module, exports, __nested_webpack_require_31090__) {
    "use strict";

    __nested_webpack_require_31090__(10);

    var $ = __nested_webpack_require_31090__(2),
        window = __nested_webpack_require_31090__(4),
        document = window.document,
        ...
        keyCode = __nested_webpack_require_31090__(0);
  ...
  }, function (module, exports, __nested_webpack_require_118613__) {
    "use strict";
    ...
    var Inputmask = __nested_webpack_require_118613__(1),
        $ = Inputmask.dependencyLib,
        keyCode = __nested_webpack_require_118613__(0),
        currentYear = new Date().getFullYear(),
        escapeRegex = __nested_webpack_require_118613__(6)["default"],
        formatCode = {
    ...
    var Inputmask = __nested_webpack_require_135577__(1),
        $ = Inputmask.dependencyLib,
        keyCode = __nested_webpack_require_135577__(0),
        escapeRegex = __nested_webpack_require_135577__(6)["default"];
    ...
    function hanndleRadixDance(pos, c, radixPos, maskset, opts) {
      return opts._radixDance && opts.numericInput && c !== opts.negationSymbol.back && pos <= radixPos && (0 < radixPos || c == opts.radixPoint) && (void 0 === maskset.validPositions[pos - 1] || maskset.validPositions[pos - 1].input !== opts.negationSymbol.back) && --pos, pos;
    }
    ...
    Inputmask.extendAliases({
      numeric: {
        ...
        onBeforeMask: function onBeforeMask(initialValue, opts) {
          ...
          if ("" !== radixPoint && (digits = !opts.digitsOptional || opts.digits < decimalPart.length ? opts.digits : decimalPart.length, "" !== decimalPart || !opts.digitsOptional)) {
  ...
  }, function (module, exports, __nested_webpack_require_157223__) {
    "use strict";

    var _window = _interopRequireDefault(__nested_webpack_require_157223__(4)),
        _inputmask = _interopRequireDefault(__nested_webpack_require_157223__(1));
  ...
  }, function (module, exports, __nested_webpack_require_162866__) {
    "use strict";
    ...
    var $ = __nested_webpack_require_162866__(3),
        Inputmask = __nested_webpack_require_162866__(1);
  ...
  }, function (module, exports, __nested_webpack_require_165504__) {
    "use strict";

    var im = __nested_webpack_require_165504__(7),
        jQuery = __nested_webpack_require_165504__(3);

    im.dependencyLib === jQuery && __nested_webpack_require_165504__(14), module.exports = im;
  }], installedModules = {}, __nested_webpack_require_167330__.m = modules, __nested_webpack_require_167330__.c = installedModules, __nested_webpack_require_167330__.d = function (exports, name, getter) {
    __nested_webpack_require_167330__.o(exports, name) || Object.defineProperty(exports, name, {
      enumerable: !0,
      get: getter
    });
  }, __nested_webpack_require_167330__.r = function (exports) {
    "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(exports, Symbol.toStringTag, {
      value: "Module"
    }), Object.defineProperty(exports, "__esModule", {
      value: !0
    });
  }, __nested_webpack_require_167330__.t = function (value, mode) {
    if (1 & mode && (value = __nested_webpack_require_167330__(value)), 8 & mode) return value;
    if (4 & mode && "object" == _typeof2(value) && value && value.__esModule) return value;
    var ns = Object.create(null);
    if (__nested_webpack_require_167330__.r(ns), Object.defineProperty(ns, "default", {
      enumerable: !0,
      value: value
    }), 2 & mode && "string" != typeof value) for (var key in value) {
      __nested_webpack_require_167330__.d(ns, key, function (key) {
        return value[key];
      }.bind(null, key));
    }
    return ns;
  }, __nested_webpack_require_167330__.n = function (module) {
    var getter = module && module.__esModule ? function getDefault() {
      return module["default"];
    } : function getModuleExports() {
      return module;
    };
    return __nested_webpack_require_167330__.d(getter, "a", getter), getter;
  }, __nested_webpack_require_167330__.o = function (object, property) {
    return Object.prototype.hasOwnProperty.call(object, property);
  }, __nested_webpack_require_167330__.p = "", __nested_webpack_require_167330__(__nested_webpack_require_167330__.s = 15);

  function __nested_webpack_require_167330__(moduleId) {
    ...
    return modules[moduleId].call(module.exports, module, module.exports, __nested_webpack_require_167330__), module.l = !0, module.exports;
  }
...
var fadeText = function fadeText(et, observer) {
  et.forEach(function (entry) {
    if (entry.isIntersecting) {
...
var textObserver = new IntersectionObserver(fadeText, options);
var videos = document.querySelectorAll(".obs-video");
var texts = document.querySelectorAll(".scroll-fade");
...
// EXTERNAL MODULE: ./src/assets/js/modules/fancy.js
var fancy = __webpack_require__(982);
// EXTERNAL MODULE: ./src/assets/js/modules/inputmask.js
var inputmask = __webpack_require__(747);
// EXTERNAL MODULE: ./src/assets/js/modules/swiper-bundle.js
var swiper_bundle = __webpack_require__(734);
var swiper_bundle_default = /*#__PURE__*/__webpack_require__.n(swiper_bundle);
;// CONCATENATED MODULE: ./src/assets/js/modules/sliders.js


var hasBlock = function hasBlock(selector) {
  return document.querySelector(selector) == null;
};

if (!hasBlock('.reviews__slider')) {
  var newProd = new (swiper_bundle_default())(".reviews__slider", {
    slidesPerView: 3,
    spaceBetween: 85.33,
    breakpoints: {
      1681: {
...
if (!hasBlock('.media__slider')) {
  var _newProd = new (swiper_bundle_default())(".media__slider", {
    slidesPerView: 3,
    spaceBetween: 16,
    slidesPerColumn: 2,
...
window.navInit = function () {
  var map_list = new (swiper_bundle_default())(".map__list", {
    slidesPerView: 'auto'
  });
};
// EXTERNAL MODULE: ./src/assets/js/modules/faq.js
var faq = __webpack_require__(446);
// EXTERNAL MODULE: ./src/assets/js/modules/ancors-with-scroll.js
var ancors_with_scroll = __webpack_require__(424);
// EXTERNAL MODULE: ./src/assets/js/modules/observers.js
var observers = __webpack_require__(964);
// EXTERNAL MODULE: ./src/assets/js/modules/gsap/gsap.js
var gsap_gsap = __webpack_require__(667);
// EXTERNAL MODULE: ./src/assets/js/modules/gsap/scrollTrigger.js
var scrollTrigger = __webpack_require__(258);
;// CONCATENATED MODULE: ./src/assets/js/modules/advanseds.js
...
horizontalSections.forEach(function (sec, i) {
  ...
  var getToValue = function getToValue() {
    return -(thisAnimWrap.scrollWidth - window.innerWidth / 1.1);
  };
  ...
  gsap.fromTo(thisAnimWrap, {
    ...
    scrollTrigger: {
      ...
      onEnter: function onEnter() {
        $('.hollidays__sliderbox').css('backgroundColor', 'transparent');
        $('.obs-item').css('backgroundColor', '#fff');
      },
      onLeave: function onLeave() {
        $('.hollidays__sliderbox,.obs-item').removeAttr('style');
      },
...
var videoItem = document.querySelectorAll('.obs-item');

var vItScroll = function vItScroll(v) {
  var p = parseInt($(v).css('padding'));
  var video = v.querySelector('.animation-wrap__video ');
  var header = v.querySelector('.animation-wrap__header');

  var getToValueVideoItem = function getToValueVideoItem() {
    return v.offsetWidth - video.offsetWidth - p * 2;
  };
...
var callback = function callback(entries, vItobserver) {
  entries.forEach(function (entry) {
    if (entry.isIntersecting) {
...
var vItobserver = new IntersectionObserver(callback, vItoptions);
videoItem.forEach(function (vt) {
  vItobserver.observe(vt);
});
// EXTERNAL MODULE: ./src/assets/js/modules/titlt.js
var titlt = __webpack_require__(751);
;// CONCATENATED MODULE: ./src/assets/js/modules/cards.js

var tilt = $('.js-card').tilt();
